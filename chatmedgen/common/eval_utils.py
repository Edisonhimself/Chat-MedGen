...
# from chatmedgen.datasets.builders import *
# from chatmedgen.models import *
# from chatmedgen.processors import *
# from chatmedgen.runners import *
# from chatmedgen.tasks import *
...
def init_model(args):
    ...
    cfg.model_cfg.freeze_vit = False
    ...
    vis_processor = registry.get_processor_class("blip2_image_eval").from_config(vis_processor_cfg)
