...
from chatmedgen.common.dist_utils import (
...
from chatmedgen.common.utils import is_url
from chatmedgen.datasets.data_utils import concat_datasets, reorg_datasets_by_split, ChainDataset
from chatmedgen.datasets.datasets.dataloader_utils import (
    IterLoader,
    MultiIterLoader,
    PrefetchLoader,
)
            ...
            if self.use_distributed:
                if self._wrapped_model is None:
                    self._wrapped_model = DDP(
                        self._model, device_ids=[self.config.run_cfg.gpu], find_unused_parameters=self.config.run_cfg.find_unused_parameters
                    )
            else:
